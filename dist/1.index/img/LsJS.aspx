...
var LR_36719='5FC4D16FD5784C71A141206635D0860D';var LiveReceptionCode_isonline = 1;
var LR_imgurl = 'https://pgt.zoosnet.net/';
var LR_40f92=LR_36719.replace(/1/g,'3').replace(/0/g,'2');var LR_lng = 'cn';
var LR_sysurl = 'https://pgt.zoosnet.net/';
var LR_isMobile = 0;
var LR_siteid = '22400314';
var LR_js_pm = 'd';
var LR_Tick=new Date().getTime().toString()+parseInt(Math.random()*499999999+Math.random()*400000000+100000000).toString();
var LR_websiteid = 'PGT22400314';
var LR_2e9ce=LR_40f92.replace(/4/g,'8').replace(/5/g,'3');var LR_DLMD=LR_2e9ce.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	...
	var _lr_helpsrc_on=unescape("http%3a%2f%2fpgt.zoosnet.net%2flr%2fimages%2fonline_cn3.gif");
	...
	var _lr_helpsrc_of=unescape("http%3a%2f%2fpgt.zoosnet.net%2flr%2fimages%2foffline_cn3.gif");
	...
	var LR_pm011=0;
	var LR_pm012=30;
	var _lr_minipath=LR_imgurl + 'LR/mini_green/';
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&EJME='+LR_DLMD;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		var minichathtml1=(typeof(minichathtml)!='function');if(minichathtml1)document.write('<link href="https://pgt.zoosnet.net/js/JS5.css" rel="stylesheet" type="text/css" />');
